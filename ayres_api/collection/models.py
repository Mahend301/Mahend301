...
class Collection(models.Model):
    ...
    taxon = models.IntegerField('taxon', blank=False, null=True)
    description = models.TextField('description', blank=True, null=True)
    floor_price = models.DecimalField('floor_price', max_digits=24, decimal_places=6, blank=False, null=False)
    daily_volume = models.DecimalField('daily volume', max_digits=24, decimal_places=6, blank=False, null=False)
    weekly_volume = models.DecimalField('weekly volume', max_digits=24, decimal_places=6, blank=False, nul=False)
    monthly_volume = models.DecimalField('monthly volume', max_digits=24, decimal_places=6, blank=False, null=False)
    total_volume = models.DecimalField('total_volume', max_digits=24, decimal_places=6, blank=False, null=False)
    ...
    twitter_link = models.URLField('twitter url', max_length=1000, blank=True, null=True)
...
class NFT(models.Model):
    ...
    status = models.CharField('status', max_length=8, choicses=NFTStatus.choices, blank=False, null=False)
